    ...
    quote do
      ...
      setup_all context do
        if unquote(options[:repo]) == :postgres do
          ...
          Enum.map([{1, EctoQLC.Repo.Migrations.CreateUser}, {2, EctoQLC.Repo.Migrations.CreateUserSession}, {3, EctoQLC.Repo.Migrations.AddTokenToUserSession}], fn {version, module} -> Ecto.Migrator.up(Repo, version, module, log: false) end)
        end
        context
      end
